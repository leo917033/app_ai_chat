...
class Yi {
    constructor(t, e, i, s, a) {
        this._rect = new Da,
        this._rect.left = t - i * .5,
        this._rect.right = t + i * .5,
        this._rect.up = e + s * .5,
        this._rect.down = e - s * .5,
        this._texture = a,
...
window.addEventListener("load", () => {
    Gt.getInstance().initialize() && Gt.getInstance().run()
}
, {
    passive: !0
});
window.addEventListener("beforeunload", () => Gt.releaseInstance(), {
    passive: !0
});
